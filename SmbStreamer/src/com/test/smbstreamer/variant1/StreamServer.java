...
//								}
//							}
							session = new HTTPSession( myServerSocket.accept());
						}
					}
...
//	}
	...
	private class HTTPSession extends Thread
	{
		...
		**/
		...
		{
			sendResponse( status, MIME_PLAINTEXT, null, null);
		 ...
		 */
		private void sendResponse( String status, String mime, Properties header, StreamSource data )
		{
			try
			{
				if ( status == null )
